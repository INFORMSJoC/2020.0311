function [CI]= out_of_sample_estimation_hassin(Cw,Cl,Cs,npatients,Po,PT,T,STlower,STupper,SimDistr,Xk,a,b,Pmed,Xmed,DerStr)
...
TC (k) = W(1:npatients-1)'*omegas*Cw + Cs*sum(S(1:npatients-1)) + Cl*W(npatients);
